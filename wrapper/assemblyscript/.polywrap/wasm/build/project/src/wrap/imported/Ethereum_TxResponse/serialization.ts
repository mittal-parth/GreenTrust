...
export function writeEthereum_TxResponse(writer: Write, type: Ethereum_TxResponse): void {
  ...
  writer.writeOptionalBigInt(type.blockNumber);
  writer.context().pop();
  writer.context().push("blockHash", "string | null", "writing property");
  writer.writeString("blockHash");
  writer.writeOptionalString(type.blockHash);
  writer.context().pop();
  writer.context().push("timestamp", "Box<u32> | null", "writing property");
  writer.writeString("timestamp");
  writer.writeOptionalUInt32(type.timestamp);
  writer.context().pop();
  ...
  writer.writeOptionalString(type.raw);
  writer.context().pop();
  writer.context().push("r", "string | null", "writing property");
  writer.writeString("r");
  writer.writeOptionalString(type.r);
  writer.context().pop();
  writer.context().push("s", "string | null", "writing property");
  writer.writeString("s");
  writer.writeOptionalString(type.s);
  writer.context().pop();
  writer.context().push("v", "Box<u32> | null", "writing property");
  writer.writeString("v");
  writer.writeOptionalUInt32(type.v);
  writer.context().pop();
  ...
  writer.writeOptionalArray(type.accessList, (writer: Write, item: Types.Ethereum_Access): void => {
...
export function readEthereum_TxResponse(reader: Read): Ethereum_TxResponse {
  ...
  let _timestamp: Box<u32> | null = null;
  ...
  while (numFields > 0) {
    ...
    if (field == "hash") {
      ...
      reader.context().push(field, "BigInt | null", "type found, reading property");
      _blockNumber = reader.readOptionalBigInt();
      reader.context().pop();
    }
    else if (field == "blockHash") {
      reader.context().push(field, "string | null", "type found, reading property");
      _blockHash = reader.readOptionalString();
      reader.context().pop();
    }
    else if (field == "timestamp") {
      reader.context().push(field, "Box<u32> | null", "type found, reading property");
      _timestamp = reader.readOptionalUInt32();
      reader.context().pop();
    }
      ...
      reader.context().push(field, "string | null", "type found, reading property");
      _raw = reader.readOptionalString();
      reader.context().pop();
    }
    else if (field == "r") {
      reader.context().push(field, "string | null", "type found, reading property");
      _r = reader.readOptionalString();
      reader.context().pop();
    }
    else if (field == "s") {
      reader.context().push(field, "string | null", "type found, reading property");
      _s = reader.readOptionalString();
      reader.context().pop();
    }
    else if (field == "v") {
      reader.context().push(field, "Box<u32> | null", "type found, reading property");
      _v = reader.readOptionalUInt32();
      reader.context().pop();
    }
    else if (field == "type") {
      reader.context().push(field, "Box<u32> | null", "type found, reading property");
      ...
      _accessList = reader.readOptionalArray((reader: Read): Types.Ethereum_Access => {
